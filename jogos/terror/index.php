...
$linksnav2['../images/perfil/ambuplay.jpg'] = 'ambuplay/';
$linksnav2['../images/perfil/pewdiepie.jpg'] = 'pewdiepie/';
$linksnav2['../images/perfil/terror-bionic.jpg'] = 'terror-bionic/';
...
<div class="container">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 padding-spacement">
        <img src="../images/capas/capa-categoria-terror.jpg" class="img-responsive">
    </div>
    ...
    <article class="col-xs-12 col-sm-9">
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-1">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/ambuplay.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-sm-8 text-center">Ambu Play</h1>

            <div class="col-xs-12 col-sm-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/uakIYgWq5_o"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/lIHxyAwejSU"></iframe>
                </div>
            </div>
        ...
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-2">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/pewdiepie.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-sm-8 text-center">PewDiePie</h1>

            <div class="col-xs-12 col-md-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/V2QecyxkEY8?list=PLYH8WvNV1YElxwhTErxWBELpvLJFrzl1M"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/0kE8p-Qgqhw?list=PLYH8WvNV1YElxwhTErxWBELpvLJFrzl1M"></iframe>
                </div>
            </div>
        ...
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-3">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/terror-bionic.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-md-8 text-center">Terror Bionic</h1>

            <div class="col-xs-12 col-md-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/fvIrzXL2bts?list=PL217AE81087FE7191"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/KCHkjtDmF1c?list=PL217AE81087FE7191"></iframe>
                </div>
            </div>
    ...
    <aside class="col-xs-12 col-sm-3" id="novidades">
        ...
        <section class="col-xs-12" id="novidades-item-1">
            ...
            <h3 class="text-center col-xs-12">PewDiePie</h3>
            ...
            <h4 class="text-center col-xs-12">NO NO NO! (SCREAMS)</h4>
        ...
        <section class="col-xs-12" id="novidades-item-2">
            ...
            <h3 class="text-center col-xs-12">AmbuPlay</h3>
            ...
            <h4 class="text-center col-xs-12">Creepy Pasta Histories</h4>
        ...
        <section class="col-xs-12" id="novidades-item-3">
            ...
            <h3 class="text-center col-xs-12">Terror Bionic</h3>

            <div class="col-xs-12 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/F4R5JoAFZUE?list=PL217AE81087FE7191"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">MEDO!</h4>
        ...
        <section class="col-xs-12" id="novidades-item-4">
            ...
            <div class="col-xs-12 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/tN4Y2IhfZKE?list=PLYH8WvNV1YElxwhTErxWBELpvLJFrzl1M"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">WOW!</h4>
    ...
    <section class="col-md-12 padding-spacement">
        ...
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zn0y3Opb8Wk"></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">PewDiePie fala sobre dinheiro</h3>
        </section>
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/zYHAP3OyTss"></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">Terror Bionic parando com terror?</h3>
        </section>
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/UBg7aqvZbPA"></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">AmbuPlay trará contos horrepílantes ao seu canal</h3>
        </section>
    </section>
</div>
<?php
