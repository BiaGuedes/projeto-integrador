...
$linksnav2['../images/perfil/dotawtf.jpg'] = 'dotawtf/';
$linksnav2['../images/perfil/drybear.jpg'] = 'drybear/';
$linksnav2['../images/perfil/gordox.jpg'] = 'gordox/';
...
<div class="container">
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 padding-spacement">
        <img src="../images/capas/capa-categoria-moba.jpg" class="img-responsive">
    </div>
    ...
    <article class="col-xs-12 col-sm-9">
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-1">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/dotawtf.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-sm-8 text-center">Dota WTF</h1>

            <div class="col-xs-12 col-sm-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/QOGzTFIclNU?list=PLmqdK5_Qu7DJwU6mT3r1_MyFrWdg8w_Qz"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/sVuspSfqQDg?list=PLmqdK5_Qu7DJwU6mT3r1_MyFrWdg8w_Qz"></iframe>
                </div>
            </div>
        ...
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-2">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/drybear.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-sm-8 text-center">DryBear</h1>

            <div class="col-xs-12 col-md-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/kDMh9NNolnc"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/FmPp8s_tAco"></iframe>
                </div>
            </div>
        ...
        <section class="col-xs-12 padding-spacement padding-bottom youtuber-section" id="perfil-youtuber-3">
            ...
            <div class="col-xs-9 col-xs-offset-2 col-sm-offset-0 col-sm-4">
                <img src="../images/perfil/gordox.jpg" class="img-circle img-responsive">
            </div>

            <h1 class="col-xs-12 col-md-8 text-center">Gordox</h1>

            <div class="col-xs-12 col-md-4 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/if2deqgx8SE?list=PLphoKBXMZ37cJcYBYLlST6vFl9IdzPalf"></iframe>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-4 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/FOysfcLSeI0?list=PLphoKBXMZ37cJcYBYLlST6vFl9IdzPalf"></iframe>
                </div>
            </div>
    ...
    <aside class="col-xs-12 col-sm-3" id="novidades">
        ...
        <section class="col-xs-12" id="novidades-item-1">
            ...
            <h3 class="text-center col-xs-12">DryBear</h3>

            <div class="col-xs-12 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/JtHmWORjGoc"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">Smite Janus Gameplay</h4>
        ...
        <section class="col-xs-12" id="novidades-item-2">
            ...
            <h3 class="text-center col-xs-12">Gordox</h3>

            <div class="col-xs-12 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/hDBwNOfZXo0?list=PLphoKBXMZ37diIAWCHwtk_XjfaWRXntzr"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">Gordox Play</h4>
        ...
        <section class="col-xs-12" id="novidades-item-3">
            ...
            <h3 class="text-center col-xs-12">DotaWtf</h3>

            <div class="col-xs-12 padding-spacement">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/Og7ChwlfQHM?list=PLmqdK5_Qu7DLlqQYSP9quVAAm8BDHXhnz"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">WTF Moments #13</h4>
        ...
        <section class="col-xs-12" id="novidades-item-4">
            ...
            <div class="col-xs-12 padding-spacement">
                ...
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item"
                            src="https://www.youtube.com/embed/WmiKOjCY9Ts?list=PLphoKBXMZ37diIAWCHwtk_XjfaWRXntzr"></iframe>
                </div>
            </div>

            <h4 class="text-center col-xs-12">Gordox na final do CBLOL</h4>
    ...
    <section class="col-md-12 padding-spacement">
        ...
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/jbbpkBpxaX4"></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">DryBear visa novo jogo: Paladins!</h3>
        </section>
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sN8iGrwFngA" ></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">Gordox fará VLOG</h3>
        </section>
        <section class="col-xs-12 col-sm-4">
            <div class="col-xs-12">
                <!-- 16:9 aspect ratio -->
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/pnCExCxtE3E"></iframe>
                </div>
            </div>
            <h3 class="text-center col-xs-12">DotaWatafak fará compilações de "Rampage"</h3>
        </section>
    </section>
</div>
<?php
