    ...
    <article class="col-sm-12 padding-spacement">
        ...
        <section class="row">
            <div class="col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1">
                <img class="img-circle img-responsive" src="../../images/perfil/drybear.jpg">
            </div>

            <h1 class="text-left col-sm-9 col-xs-12">Dry Bear</h1>
        ...
        <section class="row padding-spacement">
                ...
                <div class="col-xs-12 hidden-xs">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/7rFOVTEErG4"></iframe>
                    </div>
                </div>
            </section>
            ...
            <section class="col-xs-12 col-sm-12 padding-spacement">
                ...
                <div class="col-xs-12 col-sm-3 nopadding">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/VVNdEYm7y5s"></iframe>
                    </div>
                    <p class="text-justify col-sm-12 padding-spacement">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                ...
                <div class="col-xs-12 col-sm-3 nopadding">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/FmPp8s_tAco""></iframe>
                    </div>
                    <p class="text-justify col-sm-12 padding-spacement">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                ...
                <div class="col-xs-12 col-sm-3 nopadding">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/FYV1CdfwVgw"></iframe>
                    </div>
                    <p class="text-justify col-sm-12 padding-spacement">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ...
    <section class="col-sm-12 padding-spacement">
        ...
        <section class="col-xs-12 padding-spacement padding-bottom">
            <div class="col-xs-12 col-sm-6">
                <img src="../../images/capas/capa-part1-drybear.jpg" class="img-responsive">
            </div>

            <h2 class="text-left col-sm-6 col-xs-12 nomargin">Campeonato Mundial de Smite</h2>
            ...
            <div class="col-sm-3 col-xs-12 padding-bottom">
                <img src="../../images/icones/sub-part1-drybear.jpg" alt="" class="img-responsive">
            </div>

            <div class="col-sm-3 col-xs-12 padding-bottom">
                <img src="../../images/icones/sub-part2-drybear.jpg" alt="" class="img-responsive">
            </div>
        </section>
    </section>
</div>
