...
<hr>
    <div class="articlesa col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12 paddtop20">
        ...
        <article class="articlesa col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12 paddtop20">
                <img src="../imagens/cozinhapara2.jpg" class="canal img-responsive img-circle" alt="logo"/>
                <h1>Cozinha Para 2</h1>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <img src="../imagens/maravilhosa/rec1.jpg" class="rec1 img-responsive img-circle tamanhoimg" alt="meal" />
                  <h2 class="coluna">Receita</h2>
                  <p class="coluna text-justify hidden-xs">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
                </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <img src="../imagens/maravilhosa/rec2.jpg" class="rec1 img-responsive img-circle tamanhoimg" alt="meal" />
                  <h2 class="coluna">Receita</h2>
          ...
          <div class="row hidden-xs">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <img src="../imagens/maravilhosa/rec3.jpg" class="rec1 img-responsive img-circle tamanhoimg" alt="meal" />
              <h2 class="coluna">Receita</h2>
              <p class="coluna text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
            </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <img src="../imagens/maravilhosa/rec4.jpg" class="rec1 img-responsive img-circle tamanhoimg" alt="meal" />
              <h2 class="coluna">Receita</h2>
              <p class="coluna text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
          </div>
          </div>
...
<hr>
        <section>
            ...
            <div class="embed-responsive embed-responsive-16by9">
                <iframe width="500" height="310" src="https://www.youtube.com/embed/eWooW1KloZk"></iframe>
            </div>
            <p class="text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
            <div class="embed-responsive embed-responsive-16by9">
                <iframe width="500" height="310" src="https://www.youtube.com/embed/7Gces4cebNY"></iframe>
            </div>
            <p class="text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
            </div>
            <div class="col-md-6 col-sm-7 hidden-xs">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe width="500" height="310" src="https://www.youtube.com/embed/-KvVEWWst9s"></iframe>
            </div>
            <p class="text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
            <div class="embed-responsive embed-responsive-16by9">
                <iframe width="500" height="310" src="https://www.youtube.com/embed/kyTCWrFSJAk"></iframe>
            </div>
            <p class="text-justify">Quinta mare tellus habitandae quam mare orbem iunctarum caelumque qui caeleste ligavit: circumfluus fuerant aequalis summaque pondus tegi regna igni principio inposuit terra nix poena mixtam diverso manebat militis natus ignea zonae pondus non consistere uno magni quisquis illi sunt erat: tellus tanto pondere dixere arce natura retinebat tegit coeperunt terras coegit instabilis emicuit liberioris forma non militis sibi seductaque carmen levius altae certis suis. </p>
            </div>
